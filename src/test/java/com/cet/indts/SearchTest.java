...
public class SearchTest extends Base {
	...
	public static void getinit() throws Exception {
		indtstasksearch = GetDataFromExcel.indtstasksearch();
		childTest=true;
		parentTest=extent.createTest("Indts-Search Test");
		team="Indts";
	}
	...
	public void verifyEditEnbled() {
		Assert.assertTrue(SearchTaskPage.launch(driver));
		SearchTaskPage.inputBconnId(driver).sendKeys(indtstasksearch.get("bConnID"));
