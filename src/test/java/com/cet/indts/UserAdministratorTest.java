...
public class UserAdministratorTest extends Base {
	/**
	 * Updated on 30-sep-2020 @npatekar ::take value from DB config depeandancy
	 * removed
	 *****/
	@BeforeClass
	public static void getinit() throws Exception {
		...
		childTest=true;
		parentTest=extent.createTest("Indts-UserAdmin Test");
		team="Indts";
	}
	@BeforeMethod
	...
	public static void verifyUserAdministratorLabel() throws InterruptedException,Exception {
		softAssert.assertEquals(WriteExcel.getlabel("UseradminTitle"),UserAdminPage.getTitle(driver), "Failed : Text for text 'User Administrator  - CampaignManagement' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelUserAdmin(driver).getText(),WriteExcel.getlabel("UseradminLabel"), "Failed : Text for text 'User Administrator' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelSearchPanel(driver).getText(),WriteExcel.getlabel("UseradminSearchPanel"), "Failed : Text for text 'Search User' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelMsId(driver).getText(),WriteExcel.getlabel("MSID"), "Failed : Text for MS ID is mismatch");
		softAssert.assertEquals(UserAdminPage.labelFName(driver).getText(),WriteExcel.getlabel("fname"), "Failed : Text for 'First Name' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelLName(driver).getText(),WriteExcel.getlabel("lanme"), "Failed : Text for 'Last Name' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelEmpId(driver).getText(),WriteExcel.getlabel("empId"), "Failed : Text for 'Employee ID' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelDialingTeam(driver).getText(),WriteExcel.getlabel("dialingteam"), "Failed : Text for 'Dialingteam' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelSupervisor(driver).getText(),WriteExcel.getlabel("supervisor"), "Failed : Text for 'Supervisor' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelManager(driver).getText(),WriteExcel.getlabel("manager"), "Failed : Text for 'Manager' is mismatch");
		softAssert.assertEquals(UserAdminPage.btnCancel(driver).getText(),WriteExcel.getlabel("cancel"), "Failed : Text for 'Cancel' is mismatch");
		softAssert.assertEquals(UserAdminPage.btnReset(driver).getText(),WriteExcel.getlabel("reset"), "Failed : Text for 'Reset' is mismatch");
		softAssert.assertEquals(UserAdminPage.btnSearch(driver).getText(),WriteExcel.getlabel("search"), "Failed : Text for 'Search' is mismatch");
		softAssert.assertEquals(UserAdminPage.btnAddUser(driver).getText(),WriteExcel.getlabel("AddUser"), "Failed : Text for 'Add New User' is mismatch");
		softAssert.assertEquals(UserAdminPage.labelSearchResult(driver).getText(),WriteExcel.getlabel("searchResult"), "Failed : Text for 'Search Result' is mismatch");
		softAssert.assertEquals(UserAdminPage.headerMSID(driver).getText(),WriteExcel.getlabel("MSID"), "Failed : Text for 'MS ID' is mismatch");
		softAssert.assertEquals(UserAdminPage.headerFname(driver).getText(),WriteExcel.getlabel("fname"), "Failed : Text for 'First Name' is mismatch");
		softAssert.assertEquals(UserAdminPage.headerLName(driver).getText(),WriteExcel.getlabel("lanme"), "Failed : Text for 'Last Name' is mismatch");
		softAssert.assertEquals(UserAdminPage.headerSupervisor(driver).getText(),WriteExcel.getlabel("supervisor"), "Failed : Text for 'Supervisor' is mismatch");
		softAssert.assertEquals(UserAdminPage.headerManager(driver).getText(),WriteExcel.getlabel("manager"), "Failed : Text for 'Manager' is mismatch");
		softAssert.assertEquals(UserAdminPage.headerEmpID(driver).getText(),WriteExcel.getlabel("empId"), "Failed : Text for 'Employee ID' is mismatch");
		softAssert.assertEquals(UserAdminPage.headerAction(driver).getText(),WriteExcel.getlabel("action"), "Failed : Text for 'Action' is mismatch");
		softAssert.assertEquals(UserAdminPage.linkFirst(driver).getText(),WriteExcel.getlabel("first"), "Failed : Text for 'First' is mismatch");
		softAssert.assertEquals(UserAdminPage.linkPrevious(driver).getText(),WriteExcel.getlabel("previous"), "Failed : Text for 'Previous' is mismatch");
		softAssert.assertEquals(UserAdminPage.linkNext(driver).getText(),WriteExcel.getlabel("next"), "Failed : Text for 'Next' is mismatch");
		softAssert.assertEquals(UserAdminPage.linkLast(driver).getText(),WriteExcel.getlabel("last"), "Failed : Text for 'Last' is mismatch");
	...
	public void verifyAddUserBtnNavigation() throws Exception {
		...
		softAssert.assertEquals(UserAdminAddUserPage.getTitle(driver),WriteExcel.getlabel("UseradminAddUserTitle"), "Failed : Text for 'Add User' is mismatch");
	...
	public void verifyCancelBtnNavigation() throws Exception {
		...
		softAssert.assertEquals(HomePage.getTitle(driver),WriteExcel.getlabel("homeTitle"), "Failed : Text for 'Home Page' is mismatch");
		verifyassert(softAssert);
	}
}
