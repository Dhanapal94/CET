...
import com.cet.utility.indts.IndtsHelper;


public class IndtsConfigurationAddNewCampaignTest extends Base {
	
	private static boolean initFlag=true; 
	
	@BeforeTest
	public static void setIndtsTeam() throws Exception{
		setUp();
		IndtsHelper.setIndtsTeam(driver);
	}

	@BeforeClass
	public static void getinit() throws Exception {
		newCampaign = GetDataFromExcel.newCampaign();
		childTest=true;
		parentTest=extent.createTest("Indts-Configuration Add New Campaign Test");
		team="Indts";
	}

	@BeforeMethod
	public static void getConfigurationPageInit() throws Exception {
	...
	public void verifyAddNewCampaign() throws Exception {
		...
		ConfigurationPage.buttonAddNewCampaign(driver).click();
		ConfigurationPage.waitForPageLoad(driver);
		ConfigurationPage.inputCampaignFocus(driver).sendKeys(newCampaign.get("newcampaignfocus"));
		ConfigurationPage.inputCampaignDescription(driver).sendKeys(newCampaign.get("campaigndescription"));
		SearchEditPage.setDropDownValue(ConfigurationPage.dropDownCloneCampaignFocus(driver),
				newCampaign.get("clonecampaignfocus"));
